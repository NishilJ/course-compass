            ...
            case 'import_csv':
                if (isset($_FILES['csv_file']) && $_FILES['csv_file']['error'] === UPLOAD_ERR_OK) {
                    ...
                    if (strtolower(pathinfo($uploadedFile['name'], PATHINFO_EXTENSION)) === 'csv') {
                        ...
                        $message = "CSV Import completed: {$import_results['success']} sections added";
    ...
    <div class="admin-container">
        ...
        <div class="form-section">
            ...
            <p style="color: #666; margin-bottom: 20px;">
                Section management features are currently under construction. You can import section data from CSV below.
            </p>
        </div>
